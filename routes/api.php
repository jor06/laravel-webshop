...
Route::get('/user_phones', [App\Http\Controllers\Api\UserPhoneController::class, 'index'])->name('users.phones');

// post
Route::post('/user_orders',[App\Http\Controllers\Api\UserOrderController::class, 'store'])->name('order.store');

Route::put('/products/update/{id}', [App\Http\Controllers\Api\ProductController::class, 'update'])->name('product.stock.update');